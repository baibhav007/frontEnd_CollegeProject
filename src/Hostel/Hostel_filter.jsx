...
//       <button
//         type="button"
//         className="inline-flex items-center px-4 py-2 text-xl font-medium text-gray-700 rounded-md focus:outline-none"
...
//       {isOpen && (
//         <div className="absolute right-0 md:right-auto md:left-0 z-10 mt-2 w-full md:w-56 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
//           {/* Search Input */}
//           <div className="py-2 px-2">
//             <input
//               type="text"
//               className="block w-full px-3 py-2 text-lg text-gray-700 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
//               placeholder="Search..."
//               value={search}
...
//   );
// };
// function Hostel_filter() {
//   const stateOptions = ["Uttar Pradesh"];
//   const cityOptions = ["Gautam Buddha Nagar"];
//   const range = ["6000", "7000", "8000"];
//   const beds = ["Single beds", "Double beds", "Triple beds"];
//   const nearcollege = ["IIMT College"];
//   const gender = ["Male", "Female"];
//   return (
//     <div className="bg-slate-200 py-4">
//       <div className="flex flex-wrap justify-center md:justify-between text-lg md:text-2xl px-4 md:px-10">
//         <h2 className="border-b md:border-b-0 md:border-r border-slate-400 pr-6 mb-2 md:mb-0 h-full flex items-center">
//           Filter by
//         </h2>
//         <Dropdown label="State" options={stateOptions} />
//         <Dropdown label="City" options={cityOptions} />
//         <Dropdown label="Range" options={range} />
//         <Dropdown label="Beds" options={beds} />
//         <Dropdown label="Near College" options={nearcollege} />
//         <Dropdown label="Gender" options={gender} />
//       </div>
//     </div>
//   );
// }
// export default Hostel_filter;
...
function Collegefilter() {
  ...
  const filters = [
    ...
    { label: "Range", options: ["6000", "7000", "8000"] },
    { label: "Beds", options: ["Single beds", "Double beds", "Triple beds"] },
    { label: "Near College", options: ["IIMT College"] },
