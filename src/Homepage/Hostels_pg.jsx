...
import Visit_form from "../Hostel/visit_form";
...
function Hostel_list() {
  ...
  return (
    <div className="w-full px-4 md:px-8 lg:px-12">
      {/* header */}
      <div className="flex justify-between mb-5 m-5">
        <h1 className="text-3xl">Nearby Hostel/PG</h1>
        <div className="flex items-center">
          <img src={Location} className="h-6" loading="lazy" />
          <select className="ml-2 bg-transparent outline-none text-lg">
